...
`nwaa_hydro()` via `model_id`, and expose two extra variables — soil
moisture (`soilmst`) and recharge (`recharge`) — that the ensemble does not:
...
MIT licensed. See the [LICENSE](https://github.com/laljeet/nwaa/blob/main/LICENSE.md) file.
